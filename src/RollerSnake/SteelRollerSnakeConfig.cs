...
namespace RollerSnake {
	public class SteelRollerSnakeConfig : IEntityConfig {
		...
		public static GameObject CreateSteelRollerSnake(string id, string name, string desc,
			...
			BaseRollerSnakeConfig.SetupDiet(wildCreature, dietInfos, CaloriesPerKg,
				MinPoopSizeInKg);
			...
			scaleMonitor.dropMass = SteelPerCycle * ScaleGrowthTimeCycles;
			scaleMonitor.itemDroppedOnShear = EmitElement;
			scaleMonitor.levelCount = 2;
			scaleMonitor.targetAtmosphere = SimHashes.CarbonDioxide;
